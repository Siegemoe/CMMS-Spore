                  ...
                  <div className="mt-6 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        role="switch"
                        aria-checked={(preference?.emailEnabled ? "true" : "false") as "true" | "false"}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        role="switch"
                        aria-checked={(preference?.inAppEnabled ? "true" : "false") as "true" | "false"}
                    ...
                    {(preference?.emailEnabled || preference?.inAppEnabled) && (
                      <div className="flex items-center justify-between">
                        <div>
                          <label htmlFor={`frequency-${preference?.id}`} className="text-sm font-medium text-gray-700">
                            Frequency
                          </label>
                          <p className="text-xs text-gray-500">
